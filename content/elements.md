...
<h3 class="major">Follow us on Social Media</h3>

Our Social Media isn't active yet {{< socialLinks >}} keep checking and we'll be up and running in no time.

<code>{&zwnj;{< gmaps  pb="\<sharecode\>" >}}</code> Embedded Google Map part of the site 
